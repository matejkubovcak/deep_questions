...
export const decks = [
  ...
  },
  {
    ...
    questionIds: [...range(199, 210), ...range(91, 102)],
  },
  {
    id: 'creativity',
    name: 'Creativity',
    description: 'Prompts for making, playing, and taking an idea seriously.',
    questionIds: [...range(211, 222), ...range(103, 114)],
  },
  {
    id: 'new-worlds',
    name: 'New worlds',
    description: 'Imagine another way a life, a city, or a culture could be arranged.',
    questionIds: [...range(223, 234), 72, ...range(115, 126)],
  },
  {
    id: 'your-work',
    name: 'Your work',
    description: 'What you might actually be doing, and the work that would fit.',
    questionIds: [...range(235, 246), ...range(127, 138)],
  },
  {
    id: 'hard',
    name: 'Hard',
    description: 'Questions that do not let you off easily.',
    questionIds: [...range(247, 258), 73, 76, 78, 81, 83, 84, 86, 88, 90, ...range(139, 150)],
  },
  {
    id: 'nietzsche',
    name: 'Nietzsche',
    description: 'Self-overcoming, resentment, taste, and whether you would repeat this life.',
    note: 'Original prompts in the spirit of Nietzsche (The Gay Science, Genealogy of Morality, Zarathustra), not quotations.',
    questionIds: [...range(259, 270), ...range(151, 162)],
  },
  {
    id: 'stoics',
    name: 'Stoics',
    description: 'What is yours to do, what is only preferred, and how to meet the day.',
    note: 'Original prompts in the spirit of Epictetus, Marcus Aurelius, and Seneca, not quotations.',
    questionIds: [...range(271, 282), ...range(163, 174)],
  },
  {
    id: 'socrates',
    name: 'Socrates',
  ...
  },
  {
    ...
    note: 'Original prompts in the spirit of the Zhuangzi, not quotations.',
    questionIds: [...range(283, 294), ...range(187, 198)],
  },
]
